...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', dest='out', help='Set output path', default='../mtl-mostnet-sw', type=str)
    ...
    parser.add_argument('--epochs', dest='epochs', help='Set number of epochs', default=140, type=int)
