...
class FFTResBLock(nn.Module):
    ...
    def forward(self, x):
        ...
        return x + lcl_feats + glb_feats



class EBlock(nn.Module):
    def __init__(self, out_channel, num_res=6):
        super(EBlock, self).__init__()

        layers = [FFTResBLock(out_channel, out_channel) for _ in range(num_res)]
...
class DBlock(nn.Module):
    def __init__(self, channel, num_res=6):
